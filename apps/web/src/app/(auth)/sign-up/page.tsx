    ...
    <div className="flex items-center justify-center h-screen">
      <div className="flex flex-col gap-4 items-center justify-center">
        ...
        <Form {...form}>
          ...
          <h1 className="text-xl font-bold text-center uppercase">Sign Up Page</h1>
          <FormField
        ...
        {/* if already have an account, redirect to sign in page */}
        <p className="text-sm text-center">Already have an account? <Link href="/sign-in" className="text-blue-500 hover:text-blue-600">Sign In</Link></p>
      </div>
    </div>
  );
}
